...
const create = async (req, res) => {
	try{
		...
		var path = "/home/jignesh.mer@hs.local/projects/panteon/node-demos/ejs-node-demo/public/uploads/product/" + filename;
...
const update = async (req, res) => {
	try{
		...
		const path = "/home/jignesh.mer@hs.local/projects/panteon/node-demos/ejs-node-demo/public/uploads/product/" + filename;
